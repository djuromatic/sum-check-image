...
const ImageUpload: React.FC = () => {
    ...
    const uploadImageBinary = async (file: File) => {
        ...
        try {
            ...
            // if data.a is less then 6144 elements, pad it with 0
            if (data.a.length < 6144) {
                data.a = data.a.concat(Array(6144 - data.a.length).fill(0));
            } else if (data.a.length > 6144) {
                // slice data.a to 6144 elements
                data.a = data.a.slice(0, 6144);
            }
            if (data.length) {
                data.b = data.length;
                delete data.length;
